...
const industries = [
  { name: "Engineering", img: "/assets/industry/engineer_3dprinter_4k.png" },
  { name: "Manufacturing", img: "/assets/industry/robotic_3dprinting_4k.png" },
  { name: "Automotive", img: "/assets/industry/car_factory_4k.png" },
  { name: "Aerospace", img: "/assets/industry/aircraft_wind_tunnel_4k.png" },
  { name: "Dental", img: "/assets/industry/dental_model_4k.png" },
  { name: "Medical", img: "/assets/industry/medical_team_4k.png" },
  { name: "Education", img: "/assets/industry/engineers_demo_4k.png" },
  { name: "Entertainment", img: "/assets/industry/statue_model_4k.png" },
  { name: "Jewelry", img: "/assets/industry/product_1_4k.png" },
  { name: "Audio", img: "/assets/industry/product_2_4k.png" },
];
    ...
    <div className="ind-wrapper">
      ...
      <main className="ind-main">
        ...
        <section className="ind-intro">
          <h1>Precise and Versatile 3D Printing for Professionals Across Industries</h1>
          <p>
            Formlabs 3D printers are designed to help you excel in your industry, bringing the power of 
            advanced stereolithography and selective laser sintering 3D printing to your business at a 
            fraction of the cost of service bureaus or traditional industrial 3D printers.
          </p>
        </section>

        {/* Grid */}
        <h2 className="ind-grid-title">Select Your Industry</h2>
        <div className="ind-grid">
          {industries.map((item, idx) => (
            <a key={idx} href="#" className="ind-card">
              <img src={item.img} alt={item.name} className="ind-card-img" />
        ...
        <div className="ind-banner">
          <div className="banner-left">
            ...
            <div className="banner-text">
              <h4>Wondering how a 3D printer can help with your work?</h4>
              <p>Get a free consultation from an expert.</p>
            </div>
          </div>
          <button className="banner-btn">Find a Reseller</button>
        </div>

        {/* Scaling Section */}
        <section className="scaling-sec">
          <h2>Start Scaling Your Prototyping and Production Today</h2>
          <p>
            Explore our 3D printers to find the right solution for your business or contact a 
            Formlabs 3D printing expert for a 1-1 consultation.
          </p>
          <div className="scaling-btns">
            <button className="scale-btn btn-blue">Explore 3D Printers</button>
            <button className="scale-btn btn-outline">Find a Reseller</button>
          </div>
